...
def main():
    ...
    data = [
        ('3 декабря', 'Совкомбанк Технологии\n4.74', 'Системный аналитик (процессинг)',
         'Новосибирск • Хабаровск • Полный рабочий день',
         'Зарплата не указана\nПохожие специалисты получают 261000 - 343000',
         'Системный аналитик, Старший (Senior) • UML • SOAP • SQL • PostgreSQL • Unix • BPMN • Oracle • Java • Git • REST'),

        ('15 января', 'Совкомбанк Технологии\n4.74', 'Специалист по автоматизации тестирования',
         'Новосибирск • Томск • Уфа • Полный рабочий день',
         'Зарплата не указана\nПохожие специалисты получают 166000 - 280000',
         'Инженер по автоматизации тестирования • JavaScript • SQL • YouTrack • Appium • Selenide • Docker • Java • Postman • Apache Maven'),

        ('1 марта', 'Лаборатория Касперского\n4.2', 'Application Security Specialist',
         'Можно удаленно',
         '',
         'Инженер по обеспечению качества • Информационная безопасность'),

        ('31 декабря', 'Группа Астра\n4.54', 'Старший инженер-программист C (ядра Linux) ОС Astra Linux',
         'Москва • Полный рабочий день • Можно удаленно',
         'Зарплата не указана\nПохожие специалисты получают 237000 - 357000',
         'Десктоп разработчик, Старший (Senior) • C • Linux • Linux kernel • Системное программирование • Информационная безопасность • Git'),

        ('вчера', 'Qwintry', 'Fullstack-разработчик (PHP, Vue.js)',
         'Полный рабочий день • Можно удаленно',
         'от 1200 до 2000 $',
         'Фулстек разработчик, Старший (Senior) • PHP • Laravel • MySQL • Git • JavaScript'),

        ('сегодня', 'Data World', 'DevOps инженер',
         'Москва • Полный рабочий день • Можно удаленно',
         'до 200 000 ₽',
         'DevOps-инженер • Docker • Kubernetes • Jenkins'),
    ]

    print(f"\n📝 Загружено {len(data)} тестовых вакансий с разными датами")

    # Создаем базу данных
    conn = create_database()

    # Вставляем данные
    insert_vacancies(conn, data)
